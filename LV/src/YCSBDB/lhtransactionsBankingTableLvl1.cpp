...
std::atomic<uint32_t> ycsbc::LHTransactionsBankingTableDBLvl1::next_id(0);

ycsbc::LHTransactionsBankingTableDBLvl1::LHTransactionsBankingTableDBLvl1(
...
void ycsbc::LHTransactionsBankingTableDBLvl1::Init() {
  ...
  uint32_t t_id = ycsbc::LHTransactionsBankingTableDBLvl1::next_id.fetch_add(1);

  std::vector<bool> config = {true, true, false};
  std::vector<bool> config_2 = {true, true, false};
...
void ycsbc::LHTransactionsBankingTableDBLvl1::Close() {
...
// check balance
int ycsbc::LHTransactionsBankingTableDBLvl1::Read(
...
// withdraw
int ycsbc::LHTransactionsBankingTableDBLvl1::Scan(
...
int ycsbc::LHTransactionsBankingTableDBLvl1::Update(
    const std::string& table, const std::string& key,
...
int ycsbc::LHTransactionsBankingTableDBLvl1::Insert(
    const std::string& table, const std::string& key,
    std::vector<ycsbc::DB::KVPair>& values) {
  return 0;
}

int ycsbc::LHTransactionsBankingTableDBLvl1::Delete(const std::string& table,
                                                    const std::string& key) {
  return 0;
}

std::shared_ptr<arrow::Table>
ycsbc::LHTransactionsBankingTableDBLvl1::arrow_table_builder(
...
void ycsbc::LHTransactionsBankingTableDBLvl1::print_stats() {
