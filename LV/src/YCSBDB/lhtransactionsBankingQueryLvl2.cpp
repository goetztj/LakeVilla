...
std::atomic<uint32_t> ycsbc::LHTransactionsBankingQueryDBLvl2::next_id(0);

ycsbc::LHTransactionsBankingQueryDBLvl2::LHTransactionsBankingQueryDBLvl2(
...
void ycsbc::LHTransactionsBankingQueryDBLvl2::Init() {
  ...
  uint32_t t_id = ycsbc::LHTransactionsBankingQueryDBLvl2::next_id.fetch_add(1);
...
void ycsbc::LHTransactionsBankingQueryDBLvl2::Close() {
...
// check balance
int ycsbc::LHTransactionsBankingQueryDBLvl2::Read(
...
// withdraw
int ycsbc::LHTransactionsBankingQueryDBLvl2::Scan(
...
int ycsbc::LHTransactionsBankingQueryDBLvl2::Update(
    const std::string& table, const std::string& key,
...
int ycsbc::LHTransactionsBankingQueryDBLvl2::Insert(
    const std::string& table, const std::string& key,
    std::vector<ycsbc::DB::KVPair>& values) {
  return 0;
}

int ycsbc::LHTransactionsBankingQueryDBLvl2::Delete(const std::string& table,
                                                    const std::string& key) {
  return 0;
}

std::shared_ptr<arrow::Table>
ycsbc::LHTransactionsBankingQueryDBLvl2::arrow_table_builder(
...
void ycsbc::LHTransactionsBankingQueryDBLvl2::print_stats() {
