...
std::atomic<uint32_t> ycsbc::LHTransactionsDBLvl2::next_id(0);

ycsbc::LHTransactionsDBLvl2::LHTransactionsDBLvl2(std::string& config_path) {
...
void ycsbc::LHTransactionsDBLvl2::Init() {
  ...
  uint32_t t_id = ycsbc::LHTransactionsDBLvl2::next_id.fetch_add(1);
...
void ycsbc::LHTransactionsDBLvl2::Close() {
...
int ycsbc::LHTransactionsDBLvl2::Read(const std::string& table,
...
int ycsbc::LHTransactionsDBLvl2::Scan(
...
int ycsbc::LHTransactionsDBLvl2::Update(
...
int ycsbc::LHTransactionsDBLvl2::Insert(
    const std::string& table, const std::string& key,
    std::vector<ycsbc::DB::KVPair>& values) {
  this->read_only = false;
  auto start = std::chrono::high_resolution_clock::now();
...
int ycsbc::LHTransactionsDBLvl2::Delete(const std::string& table,
                                        const std::string& key) {
  this->read_only = false;
  this->manager->begin_transaction_ycsb();
...
std::shared_ptr<arrow::Table> ycsbc::LHTransactionsDBLvl2::arrow_table_builder(
...
void ycsbc::LHTransactionsDBLvl2::print_stats() {
