...
cd aws-sdk-cpp & mkdir build && cd build && cmake ./../aws-sdk-cpp -DCMAKE_INSTALL_PREFIX=/LakeVilla/aws -DBUILD_ONLY="s3" -DBUILD_SHARED_LIBS=ON -DENABLE_UNITY_BUILD=ON -DCMAKE_BUILD_TYPE=Release
cmake --build .
cmake --install .
