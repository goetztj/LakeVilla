#pragma once
#ifndef YCSB_C_LHTRANSACTIONSBANKINGQUERYLVL2_DB_H_
#define YCSB_C_LHTRANSACTIONSBANKINGQUERYLVL2_DB_H_
...
class LHTransactionsBankingQueryDBLvl2 : public DB {
 public:
  LHTransactionsBankingQueryDBLvl2(std::string& config_path);
  void Init();
