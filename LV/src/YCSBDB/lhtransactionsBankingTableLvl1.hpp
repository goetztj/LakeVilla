#pragma once
#ifndef YCSB_C_LHTRANSACTIONSBANKINGTABLELVL1_DB_H_
#define YCSB_C_LHTRANSACTIONSBANKINGTABLELVL1_DB_H_
...
class LHTransactionsBankingTableDBLvl1 : public DB {
 public:
  LHTransactionsBankingTableDBLvl1(std::string& config_path);
