#pragma once
#ifndef YCSB_C_LHTRANSACTIONSBANKINGTABLELVL2_DB_H_
#define YCSB_C_LHTRANSACTIONSBANKINGTABLELVL2_DB_H_
...
class LHTransactionsBankingTableDBLvl2 : public DB {
 public:
  LHTransactionsBankingTableDBLvl2(std::string& config_path);
  void Init();
