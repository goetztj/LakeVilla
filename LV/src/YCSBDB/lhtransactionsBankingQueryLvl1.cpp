...
std::atomic<uint32_t> ycsbc::LHTransactionsBankingQueryDBLvl1::next_id(0);

ycsbc::LHTransactionsBankingQueryDBLvl1::LHTransactionsBankingQueryDBLvl1(
...
void ycsbc::LHTransactionsBankingQueryDBLvl1::Init() {
  ...
  uint32_t t_id = ycsbc::LHTransactionsBankingQueryDBLvl1::next_id.fetch_add(1);

  std::vector<bool> config = {true, true, false};
  this->manager0 = std::make_unique<LHTransactions::TransactionManagerGeneric>(
      config, path0, config2, t_id);
}

void ycsbc::LHTransactionsBankingQueryDBLvl1::Close() {
...
// check balance
int ycsbc::LHTransactionsBankingQueryDBLvl1::Read(
...
// withdraw
int ycsbc::LHTransactionsBankingQueryDBLvl1::Scan(
...
int ycsbc::LHTransactionsBankingQueryDBLvl1::Update(
    const std::string& table, const std::string& key,
...
int ycsbc::LHTransactionsBankingQueryDBLvl1::Insert(
    const std::string& table, const std::string& key,
    std::vector<ycsbc::DB::KVPair>& values) {
  return 0;
}

int ycsbc::LHTransactionsBankingQueryDBLvl1::Delete(const std::string& table,
                                                    const std::string& key) {
  return 0;
}

std::shared_ptr<arrow::Table>
ycsbc::LHTransactionsBankingQueryDBLvl1::arrow_table_builder(
...
void ycsbc::LHTransactionsBankingQueryDBLvl1::print_stats() {
