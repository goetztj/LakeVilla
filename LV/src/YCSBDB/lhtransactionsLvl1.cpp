...
std::atomic<uint32_t> ycsbc::LHTransactionsDBLvl1::next_id(0);

ycsbc::LHTransactionsDBLvl1::LHTransactionsDBLvl1(std::string& config_path) {
...
void ycsbc::LHTransactionsDBLvl1::Init() {
  ...
  uint32_t t_id = ycsbc::LHTransactionsDBLvl1::next_id.fetch_add(1);
...
void ycsbc::LHTransactionsDBLvl1::Close() {
...
int ycsbc::LHTransactionsDBLvl1::Read(const std::string& table,
...
int ycsbc::LHTransactionsDBLvl1::Scan(
...
int ycsbc::LHTransactionsDBLvl1::Update(
...
int ycsbc::LHTransactionsDBLvl1::Insert(
    const std::string& table, const std::string& key,
    std::vector<ycsbc::DB::KVPair>& values) {
  this->read_only = false;
  auto start = std::chrono::high_resolution_clock::now();
...
int ycsbc::LHTransactionsDBLvl1::Delete(const std::string& table,
                                        const std::string& key) {
  this->read_only = false;
  this->manager->begin_transaction_ycsb();
...
std::shared_ptr<arrow::Table> ycsbc::LHTransactionsDBLvl1::arrow_table_builder(
...
void ycsbc::LHTransactionsDBLvl1::print_stats() {
