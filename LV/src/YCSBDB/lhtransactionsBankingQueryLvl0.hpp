#pragma once
#ifndef YCSB_C_LHTRANSACTIONSBANKINGQUERYLVL0_DB_H_
#define YCSB_C_LHTRANSACTIONSBANKINGQUERYLVL0_DB_H_
...
class LHTransactionsBankingQueryDBLvl0 : public DB {
 public:
  LHTransactionsBankingQueryDBLvl0(std::string& config_path);
  void Init();
