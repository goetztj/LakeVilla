#pragma once
#ifndef YCSB_C_LHTRANSACTIONSLVL2_DB_H_
#define YCSB_C_LHTRANSACTIONSLVL2_DB_H_
...
class LHTransactionsDBLvl2 : public DB {
 public:
  LHTransactionsDBLvl2(std::string& config_path);
  void Init();
 ...
 private:
  ...
  std::unique_ptr<LHTransactions::TransactionManager> manager;
