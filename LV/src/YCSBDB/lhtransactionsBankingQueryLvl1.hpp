#pragma once
#ifndef YCSB_C_LHTRANSACTIONSBANKINGQUERYLVL1_DB_H_
#define YCSB_C_LHTRANSACTIONSBANKINGQUERYLVL1_DB_H_
...
class LHTransactionsBankingQueryDBLvl1 : public DB {
 public:
  LHTransactionsBankingQueryDBLvl1(std::string& config_path);
  void Init();
